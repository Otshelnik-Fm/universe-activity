...
- Интеграция с дополнением [User Info Tab](https://codeseller.ru/products/user-info-tab/) - но без постраничной навигации. Последние 30 событий пользователя. Ограничения снимаются **Universe Activity Extended** 
